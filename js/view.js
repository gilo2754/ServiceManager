...
export default class View {
  constructor() {
    ...
    this.addTodoForm.onClick((title, description, price) => this.addTodo(title, description, price));
  ...
  addTodo(title, description, price) {
    const todo = this.model.addTodo(title, description, price);
    this.createRow(todo);
  ...
  editTodo(id, values) {
    ...
    row.children[2].innerText = values.price;
